		    ...
		    <div class="row no-gutters">
		      <div class="col-3 bg-white">
		        	<div class=" w3-bar-block w3-light-blue w3-card" style="width:200px;margin-top: 10%;;margin-bottom: 10%">
					  ...
					  <a href="#" class="w3-bar-item w3-button   w3-bottombar w3-hover-border-blue" style="padding-top: 30px;text-decoration:none">View Patient</a>
		      ...
		      <div class="col-4 w3-light-grey" style = "padding: 15px;border-radius: 10px;height: 200px;">
					<center><form action="viewPatientServlet" method = "post">
